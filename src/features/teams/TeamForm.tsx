 ...
 * and the corrections screen so the two can never drift apart (the original app shared these fields
 * via `features/teams/constants` plus duplicated markup; one component is the honest version).
 *
 * The sport picker is a pair of outlined chips rather than a segmented control: the Back Page has no
 * pill-shaped anything, and two ruled boxes say "pick one" just as clearly.
 */
...
/**
 * The Back Page has no team colours to pick — paper, ink and one red is the whole palette — but the
 * stored record still carries a colour. New teams take the ink; an edited team keeps what it had.
 */
export const DEFAULT_TEAM_COLOUR = "#141311";
  ...
  return (
    <>
      ...
      <div className={css.field}>
        ...
        <p className={cx(styles.note, styles.noteNormal)}>
          Any number works, and you can change it for a single match.
        </p>
      </div>
    </>
  );
